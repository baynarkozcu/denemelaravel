...
<head>
  ...
  <title>@yield("title","Enes ÖZÜDOĞRU")</title>
...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
    <div class="container">
      <a class="navbar-brand" href="{{route("homepage")}}">Enes ÖZÜDOĞRU</a>
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          ...
          @foreach ($pages as $page)
            <li class="nav-item">
                <a class="nav-link" href="{{route("page",$page->id)}}">{{$page->pageTitle}}</a>
            </li>
          @endforeach
          <li class="nav-item">
