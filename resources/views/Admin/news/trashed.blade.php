                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold float-left text-primary">Toplamda {{count($news)}} Adet Silinen Haber Bulundu.</h6>
                                <!-- BİR ÖNCEKİ URL E GİDİYOR. FAKAT SAYFA SORUNLU DÜZELTİLMESİ GEREKİYOR... -->
                            <a href="{{url()->previous()}}" class="float-right btn btn-success btn-sm"><i class="fa fa-eye"></i>Tüm Haberler</a>
                                ...
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="{{route("hardDelete",$new->id)}}" class="btn btn-sm btn-danger"><i class="fa fa-trash"></i>Kalıcı Sil</a></td>
                                        </tr>
                                        @endforeach
                                    </tbody>
                                </table>
